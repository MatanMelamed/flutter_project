...
class _CreateUserPageState extends State<CreateUserPage> {
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: () async {
                        ...
                        if (error.isNotEmpty) {
                          ...
                          var authSignUpResult = await _auth.registerWithEmailAndPassword(email, password);
                          ...
                          if (authSignUpResult == null) {
                            ...
                            // add to database
                            await UserDataManager.createUser(newUser, _imageProfile);
  ...
  String validateError() {
    ...
    error += Validator.ValidateEmail(_emailController.text) +
        Validator.ValidatePasswords(_passwordController.text, _passwordValidationController.text) +
        Validator.ValidateFullName('${_firstNameController.text} ${_lastNameController.text}') +
